...
const getUserBookmarks = async (URL, userId) => {
  const response = await fetch(`${URL}/users/${userId}/bookmarks`, {
    method: "GET",
  });
...
const BookmarksPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const userData = await getUserBookmarks(URL, currentUser._id);
      setBookmarks(userData);
    };

    fetchData();
    setBookmarkChange(false);
  }, [currentUser._id, bookmarkChange]);
